	...
	<div class="container-fluid">
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row">
				...
				<div class="col-md-8">
						<form:form method="POST" class="form-horizontal" action="insert_group.html" modelAttribute="group">
							<div class="form-group">
								<label class="col-sm-2 control-label">Group Name</label>
								<div class="col-sm-10">
									<form:input path="groupName" type="text" class="form-control" placeholder="Group Name"></form:input>
								</div>
							</div>
							<div class="form-group">
